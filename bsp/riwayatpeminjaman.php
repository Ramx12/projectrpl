...
if ($filter_status !== 'all') {
    $query .= " AND pf.status = '" . $conn->real_escape_string($filter_status) . "'";
}

if (!empty($filter_bulan)) {
    $query .= " AND DATE_FORMAT(pf.tanggal_mulai, '%Y-%m') = '" . $conn->real_escape_string($filter_bulan) . "'";
}
...
// Get statistics
$total_peminjaman = $conn->query("SELECT COUNT(*) as total FROM peminjaman_fasilitas")->fetch_assoc()['total'];
...
$total_ditolak = $conn->query("SELECT COUNT(*) as total FROM peminjaman_fasilitas WHERE status = 'ditolak'")->fetch_assoc()['total'];
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Riwayat Peminjaman Fasilitas - BSP</title>
        ...
        <div class="dashboard-header">
            <div class="container">
                <div class="dashboard-nav">
                    <div class="nav-brand">
                        ...
                        <div class="dashboard-title">
                            ...
                            <p>Biro Sarana Prasarana - Pengelola Fasilitas</p>
                        </div>
                    </div>
                    <div class="user-info">
                ...
                <div class="dashboard-menu">
                    ...
                    <a href="riwayatpeminjaman.php" class="active"><i class="fas fa-list"></i> Semua Peminjaman</a>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">Data Peminjaman Fasilitas</h2>
                </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><strong><?= $row['jumlah_pinjam'] ?></strong> unit</td>
                                            <td>
